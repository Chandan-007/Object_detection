...
# YouTube video URL
youtube_url = "https://www.youtube.com/watch?v=7HaJArMDKgI"

# Download YouTube video with HD resolution
print("Downloading YouTube video...")
yt = YouTube(youtube_url)
video_stream = yt.streams.filter(file_extension="mp4", resolution="720p").first()

# Open the video capture object directly from the YouTube URL
